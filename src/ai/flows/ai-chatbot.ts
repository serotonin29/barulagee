...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI chatbot designed to answer questions about learning materials.  Provide clear and concise answers.  Use reasoning to explain complex concepts in a simple manner.  Be helpful and interactive.
